...
struct LyricsView: View {
    ...
    func parseSyncedLyrics(_ lyrics: String) -> [LyricLine] {
        ...
        for line in lyrics.components(separatedBy: "\n") {
            ...
            let timeString = String(line[line.index(after: line.startIndex)..<end])
            let text = String(line[line.index(after: end)...])
    ...
    private func parseLine(_ line: String) -> LyricLine? {
        ...
        let text = String(line[line.index(after: closingBracket)...])
