...
struct SpotifyPlaylistDetailView: View {
    ...
    @State private var isTransferringPlaylist =
        false
    ...
    var body: some View {
        ...
        .toolbar {
            ...
            ToolbarItem(
                ...
                Menu {
                    ...
                    Button(
                        "spotifyplaylistdetailview_transfer_to_echo",
                ...
                .accessibilityLabel(
                    "spotifyplaylistdetailview_playlist_actions"
                )
            }
        }
        ...
        .confirmationDialog(
            "spotifyplaylistdetailview_transfer_confirmation",
            ...
            Text(
                "spotifyplaylistdetailview_transfer_message"
            )
        }

        .alert(
            "spotifyplaylistdetailview_transfer_result",
            isPresented: $showTransferResult
        ) {
    ...
    @MainActor
    private func transferPlaylistToEcho() {

        guard !isTransferringPlaylist,
              !tracks.isEmpty
        else {
            return
        }
